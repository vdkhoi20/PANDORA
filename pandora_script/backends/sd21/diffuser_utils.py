        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                latent_model_input=torch.cat([latents_intermediate[-i-1],latents[1:]])
                ...
                if local_mask is not None and guidance_scale_LADG > 0.0:
                    noise_pred_uncond, noise_pred_text = noise_pred.chunk(2)
                    noise_pred = (noise_pred_uncond + guidance_scale_LADG * (noise_pred_text - noise_pred_uncond))*local_mask +\
                        noise_pred_text * (1 - local_mask)
